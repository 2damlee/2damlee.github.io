...
- 문자열 정규식 예외처리
  ...
  2. -_.제외한 특수문자 제거
  3. 두 개 이상의 '.'은 하나로 대체
  4. 아이디 처음에 '.'이 나올 경우 제거
  5. 빈 문자열인 경우 "a"로 대체
  6. 16글자 넘어갈 시 15 초과 제거
  7. 아이디 길이가 2자 이하인 경우 끝 문자를 길이가 3이 될 때까지 반복
...
[제목 없음](https://www.notion.so/a654ff6ab9114e3fb1897bad2770ada9)

[제목 없음](https://www.notion.so/ab8bdafc9ffd421c86587cb71b41a09b)